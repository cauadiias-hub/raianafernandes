...
import { heroSpaceDataUrl } from "./hero-asset";
...
export default function Home() {
  return <main>
    ...
    <section className="hero" id="inicio" aria-labelledby="hero-title">
      <img className="hero-image" src={heroSpaceDataUrl} alt="Ambiente sereno iluminado pela luz do dia, com uma poltrona próxima à janela" />
      <div className="hero-overlay" />
      <div className="hero-content content-wrap"><p className="eyebrow hero-kicker">Psicologia e psicoterapia</p>
        <h1 id="hero-title">Cada fase da vida traz perguntas diferentes.<em> Um espaço de escuta pode ajudar a atravessá-las.</em></h1>
        <div className="hero-bottom"><p>Psicoterapia para adolescentes, adultos e idosos, com atendimento sob agendamento.</p><div className="hero-actions"><WhatsAppLink className="button button-light">Agendar uma conversa <ArrowUpRight size={18} aria-hidden="true" /></WhatsAppLink><a className="text-link text-link-light" href="#psicoterapia">Conhecer a psicoterapia <ArrowDownRight size={18} aria-hidden="true" /></a></div></div>
      </div><p className="hero-index" aria-hidden="true">01 / 05</p>
    </section>
